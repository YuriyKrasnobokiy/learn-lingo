import{u as t,G as m,j as o,F as M,e as T,E as S,f as A,g as d,h as _,_ as w,r as p,M as E,i as W,k as G,b as H,c as b,l as P,m as N,t as O}from"./index-DIqlvuMU.js";const Pe=t.div`
  display: flex;
  max-width: 1312px;
...
`,$=({teacher:e})=>o.jsx(be,{children:e.levels.map(r=>o.jsxs(Le,{children:["#",r]},k()))}),Te=t.h2`
  font-weight: 500;
  font-size: 40px;
  line-height: 1.2;
...
`,Se=A().shape({option:d().required("Please select an option"),name:d().min(2).required("Required"),email:d().email("Invalid email").required("Required"),phone:d().min(10,"Invalid phone number").required("Required")}),Ae=({openModal:e})=>{const r={option:"",name:"",email:"",phone:""},l=(n,{resetForm:s})=>{s(),e(),w.success(`Thank you ${n.name}! Our manager will call you soon 😊 Have a nice day 😉`,{duration:5e3})};return o.jsxs(o.Fragment,{children:[o.jsx(Be,{children:"What is your main reason for learning English?"}),o.jsx(_,{initialValues:r,validationSchema:Se,onSubmit:l,children:o.jsxs(Fe,{children:[o.jsxs(Re,{children:[o.jsx(x,{component:"p",name:"option"}),o.jsxs(a,{children:[o.jsx(c,{type:"radio",name:"option",value:"Career and business"}),"Career and business"]}),o.jsxs(a,{children:[o.jsx(c,{type:"radio",name:"option",value:"Lesson for kids"}),"Lesson for kids"]}),o.jsxs(a,{children:[o.jsx(c,{type:"radio",name:"option",value:"Living abroad"}),"Living abroad"]}),o.jsxs(a,{children:[o.jsx(c,{type:"radio",name:"option",value:"Exams and coursework"}),"Exams and coursework"]}),o.jsxs(a,{children:[o.jsx(c,{type:"radio",name:"option",value:"Culture, travel or hobby"}),"Culture, travel or hobby"]})]}),o.jsxs(ze,{children:[o.jsx(x,{component:"p",name:"name"}),o.jsx(j,{type:"text",name:"name",placeholder:"Full Name"}),o.jsx(x,{component:"p",name:"email"}),o.jsx(j,{type:"email",name:"email",placeholder:"Email"}),o.jsx(x,{component:"p",name:"phone"}),o.jsx(j,{type:"text",name:"phone",placeholder:"Phone number"})]}),o.jsx(Me,{type:"submit",children:"Book"})]})})]})},_e=({teacher:e,openModal:r})=>o.jsxs(o.Fragment,{children:[o.jsx(Te,{children:"Book trial lesson"}),o.jsx(we,{children:"Our experienced tutor will assess your current language level, discuss your learning goals, and tailor the lesson to your specific needs."}),o.jsxs(ye,{children:[o.jsx(ke,{src:e.avatar_url,alt:"avatar"}),o.jsxs("div",{children:[o.jsx($e,{children:"Your teacher"}),o.jsxs(Ie,{children:[e.name," ",e.surname]})]})]}),o.jsx(Ae,{openModal:r})]}),Ee=({teacher:e})=>{const[r,l]=p.useState(!1),n=()=>{l(s=>!s)};return o.jsx(o.Fragment,{children:o.jsxs(ae,{children:[o.jsx(ce,{children:e.experience}),o.jsx(de,{children:e.reviews.map(s=>o.jsxs(he,{children:[o.jsxs(xe,{children:[o.jsx(pe,{children:o.jsx(Ce,{})}),o.jsxs("div",{children:[o.jsx(me,{children:s.reviewer_name}),o.jsxs(ge,{children:[o.jsx("img",{src:y,alt:"star"}),o.jsx(ue,{children:s.reviewer_rating.toFixed(1)})]})]})]}),o.jsx(fe,{children:s.comment})]},k()))}),o.jsx($,{teacher:e}),o.jsx(je,{type:"button",onClick:n,children:"Book trial lesson"}),r&&o.jsx(E,{openModal:n,children:o.jsx(_e,{teacher:e,openModal:n})})]})})},Oe=e=>e.teachersStore.favoriteTeachers,We=e=>e.teachersStore.selectedTeachersIds,qe=({teacher:e})=>{const[r,l]=p.useState(null),n=W(),[s,v]=p.useState(!1);p.useEffect(()=>{const i=G(b,z=>{v(!!z)});return()=>i()},[]);const C=H(We).includes(e.id),I=b.currentUser,B=i=>{n(C?P(i):N({...i,owner:I.uid})),n(O(i.id))},F=i=>{l(i===r?null:i)},R=()=>{s?B(e):w.error("You must be logged in to add to favorites")};return o.jsx(o.Fragment,{children:o.jsxs(q,{children:[o.jsxs(Z,{children:[o.jsx(D,{src:e.avatar_url,alt:"avatar"}),o.jsx(V,{src:ne,alt:"online"})]}),o.jsxs("div",{children:[o.jsxs(Y,{children:[o.jsx(U,{children:"Langueges"}),o.jsxs(J,{className:"teacher-info",children:[o.jsx(h,{children:o.jsxs(L,{children:[o.jsx(se,{style:{marginRight:"12px"}}),"Lessons online"]})}),o.jsxs(h,{children:["Lessons done: ",e.lessons_done]}),o.jsx(h,{children:o.jsxs(L,{children:[o.jsx(K,{src:y,alt:"star"}),"Rating: ",e.rating]})}),o.jsxs(h,{children:["Price / 1 hour:"," ",o.jsxs(Q,{children:[e.price_per_hour,"$"]})]})]}),o.jsx(X,{type:"button",onClick:R,children:C?o.jsx(ie,{}):o.jsx(le,{})})]}),o.jsxs(ee,{children:[e.name," ",e.surname]}),o.jsxs(oe,{children:[o.jsx(g,{children:o.jsxs(u,{children:[o.jsx(f,{children:"Speaks: "}),o.jsx(te,{children:e.languages.join(", ")})]})}),o.jsx(g,{children:o.jsxs(u,{children:[o.jsx(f,{children:"Lesson Info: "}),e.lesson_info]})}),o.jsx(g,{children:o.jsxs(u,{children:[o.jsx(f,{children:"Conditions: "}),e.conditions]})})]}),r!==e.id&&o.jsxs(o.Fragment,{children:[o.jsx(re,{type:"button",onClick:()=>F(e.id),children:"Read more"}),o.jsx($,{teacher:e})]}),r===e.id&&o.jsx(Ee,{teacher:e})]})]},e.id)})};export{Ne as L,Pe as T,qe as a,Oe as s};
